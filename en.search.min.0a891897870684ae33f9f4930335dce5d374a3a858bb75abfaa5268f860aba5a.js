...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dd9af8d67a5aec34f9c3899f77ad624512cbe204817983fd7f68dc498a9d7edb.js',function(){input.required=false;search();});}
